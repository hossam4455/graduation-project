                    ...
                    <div className="navbar-nav ms-auto py-0">
                        ...
                        <div className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu m-0">
                                ...
                                <a href="testimonial.html" className="dropdown-item">The Patients Reviews</a>
                                <a href="appointment.html" className="dropdown-item">Appointment</a>
                                <a href="search.html" className="dropdown-item">Search</a>
                            </div>
                        </div>
                        <a href="contact.html" className="nav-item nav-link">Contact</a>
                        <a href="html.html" className="nav-item nav-link">Login</a>
                        <div className="nav-item dropdown">
                            <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Signup</a>
                            <div className="dropdown-menu m-0">
                                <a href="" className="dropdown-item">Doctor</a>
        ...
        <div className="container py-5">
            <div className="row justify-content-start">
                <div className="col-lg-8 text-center text-lg-start">
                    ...
                    <div className="pt-2">
                        <a href="search.html" className="btn btn-light rounded-pill py-md-3 px-md-5 mx-2">Find Doctor</a>
                        <a href="appointment.html" className="btn btn-outline-light rounded-pill py-md-3 px-md-5 mx-2">Appointment</a>
                    </div>
                </div>
            </div>
        </div>
