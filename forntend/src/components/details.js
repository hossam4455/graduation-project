            ...
            <div class="row">
                <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-decoration-none text-body pe-3" href="/Details"><i class="bi bi-telephone me-2"></i>+0111 054 3007</a>
                        <span class="text-body">|</span>
                        <a class="text-decoration-none text-body px-3" href="/Details"><i class="bi bi-envelope me-2"></i>Gad@gmail.com</a>
                    </div>
                </div>
                <div class="col-md-6 text-center text-lg-end">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-body px-2" href="/Details">
                        ...
                        <a class="text-body ps-2" href="/Details">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="/Details" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-md-0">&copy; <a class="text-primary" href="/">CMS</a>. All Rights Reserved.</p>
            </div>
            <div class="col-md-6 text-center text-md-end">
                <p class="mb-0">Designed by <a class="text-primary" href="/">GaAaD</a></p>
            </div>
        </div>
    </div>
</div>
